    ...
    <tr>
        ...
        <td class="container">
            <div class="content">
                ...
                <span class="preheader">Pengajuan Cuti</span>
                <table class="main">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        ...
                                        <p>Berikut adalah pengajuan cuti</p>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tbody>
                                                    ...
                                                    <?php
                                                        ...
                                                        }else if($datacuti->jenis_cuti == 'C17'){
                                                            $jenis_cuti = 'Sakit';
                                                        }else{
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td>Tgl cuti Awal {{$jenis_cuti}}</td>
                                                        <td> : </td>
                                                        <td>{{$datacuti->tgl_cuti_awal}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Tgl cuti Akhir {{$jenis_cuti}}</td>
                                                        <td> : </td>
                                                        <td>{{$datacuti->tgl_cuti_akhir}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Lama cuti {{$jenis_cuti}}</td>
                                                        <td> : </td>
                                                        <td>{{$datacuti->jumlah_hari}}</td>
                                                    </tr>
                                                    @endforeach
                                                    <tr>
                                                        <td colspan="3"></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <br><br>
                                                            <a href="{{url('/backend/cuti/approve_cuti/')}}{{'/'.$id}}">
