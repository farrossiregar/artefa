...
header("Content-Disposition: attachment; filename=Report Absensi Akumulatif - ".\Carbon\Carbon::now()->format('d-F-Y').".xls");
?>
  ...
  <table class="table table-striped table-bordered table-hover" width="100%">
    <tbody>
      <tr>
        ...
        <th colspan="{{$cols}}"><div align="center"><h3>Report Absensi Akumulatif {{$karyawan->nama}}</h3></div></th>
        @else
        <th colspan="{{$cols}}"><div align="center"><h3>Report Absensi Akumulatif {{$var4}}</h3></div></th>
        @endif
      </tr>
      <tr>
        <th colspan="{{$cols}}"><div align="center">Tahun : {{$tahun}}</div></th>
      </tr>
    </tbody>
  </table>
  <br>
  <table class="table table-striped table-bordered table-hover" border="1" width="1200">
      <thead>
          <tr>
              <th rowspan="2" bgcolor="#6cddbf" style="vertical-align: middle;"><div align="center">No</div></th>
              @if($berdasarkan == 1)
              <th rowspan="2" valign="center" bgcolor="#6cddbf" style="vertical-align: middle;"><div align="center" style="width: 100px;">NIK</div></th>
          ...
          <tr>
            ...
            <th bgcolor="#6cddbf" width="300"><div align="center">{{$month->M}}</div></th>
            @endforeach
          </tr>
     </thead>
     <tbody>
      ...
      @else
        ...
        ?>
            <tr>
                ...
                ?>
                <td width="300"><div align="center">{{$persenhadir}}</div></td>
                @endforeach
                @endif
            </tr>
        @endforeach
