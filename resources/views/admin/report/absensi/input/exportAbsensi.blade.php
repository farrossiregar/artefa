...
header("Content-Disposition: attachment; filename=Report Absensi Bulan  - ".\Carbon\Carbon::now()->format('d-F-Y').".xls");
?>
  ...
  <table class="table table-striped table-bordered table-hover" width="100%">
    <tbody>
      <tr>
        ...
        <th colspan="23"><div align="center"><h3>Report Absensi {{$karyawan->nama}}</h3></div></th>
        @else
        <th colspan="23"><div align="center"><h3>Report Absensi {{$var4}}</h3></div></th>
        @endif
      </tr>
      <tr>
        <th colspan="23"><div align="center">Periode : {{\Carbon\Carbon::parse($dateFrom)->format('d-F-Y')}} - {{\Carbon\Carbon::parse($dateTo)->format('d-F-Y')}}</div></th>
      </tr>
    </tbody>
  </table>
  <br>
  <table class="table table-striped table-bordered table-hover" width="1200" border="1">
      <thead>
          <tr>
