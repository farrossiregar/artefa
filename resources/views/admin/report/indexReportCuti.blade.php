						...
						<div class="col-lg-12">
							<div class="panel panel-default">
								...
								<br>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="col-md-3">
													<div class="form-group">
														<br>
														<button class="btn btn-success" onclick="getTableCuti();"><i class="icon-ok"></i> Submit</button>
									...
									<div class="row">
										<div class="col-md-12" id="reportcuti">
										</div>
										<div class="col-md-12" style="display:none;">
											@ include('admin.report.input.ReportCutiTable')
										</div>
									</div>
									<div class="col-md-12" >
										<div class="row">
											<form action="{{url('/backend/report/report_cuti/export')}}" method="post">
												...
												<button id="btnexp" class="btn btn-success" style="display:none;"><i class="icon-ok"></i> Export</button>
											</form>
										</div>
										<br>
									</div>
