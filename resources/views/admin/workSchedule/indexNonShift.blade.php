...
<div class="row">
    <div class="col-lg-12">
        <h2> Input Jadwal Non Shifting </h2>
    </div>
</div>
<hr />
<div class="row">
                ...
                <div class="table-responsive">
                	<div class="col-md-12" style="padding-bottom: 60px;">
                		...
                		<div class="col-md-8">
                            ...
                            <div class="col-md-2">
                                <button class="btn btn-primary" onclick="getDaysNonShift()">Reload Data</button>
                            </div>
                        </div>
                	</div>
                    <div class="col-md-12 table-responsive" id="nonshiftTable">
